...
class Task(MethodView):
    ...
    def post(self):
        ...
        to_client, to_code_runner = validate_and_decrypt_task_info(key_manager, 
                                                                   json_dic["client_key"], 
        ...
        executor.submit(self.run_and_record, 
                        to_code_runner["client_public_key"], 
                        to_code_runner["aes_key"], 
                        to_code_runner["task_hash"], 
                        to_code_runner["to_code_runner"])
    ...
    def get(self):
        ...
        if task_hash_base64 != "-1":
            ...
            for block in all_blocks:
                all_blocks_base64 = dic_bytes_content_to_base64(block)
